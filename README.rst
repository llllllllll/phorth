...
.. code-block::
   ...
   [<Word '!': addr=412, immediate=False>,
    ...
    <Word '*': addr=587, immediate=False>,
    <Word '+': addr=555, immediate=False>,
    <Word ',': addr=218, immediate=False>,
    <Word '-': addr=601, immediate=False>,
    <Word '-rot': addr=1037, immediate=False>,
    <Word '.': addr=631, immediate=False>,
    <Word '.s': addr=458, immediate=False>,
    <Word '/': addr=563, immediate=False>,
    <Word '/mod': addr=472, immediate=False>,
    <Word '0<': addr=831, immediate=False>,
    <Word '0=': addr=849, immediate=False>,
    <Word '0>': addr=867, immediate=False>,
    <Word '0branch': addr=448, immediate=True>,
    <Word '1+': addr=973, immediate=False>,
    <Word '1-': addr=991, immediate=False>,
    <Word '2*': addr=885, immediate=False>,
    <Word '2+': addr=903, immediate=False>,
    <Word '2-': addr=921, immediate=False>,
    <Word '2/': addr=939, immediate=False>,
    <Word '2drop': addr=957, immediate=False>,
    <Word '2dup': addr=541, immediate=False>,
    <Word ':': addr=641, immediate=False>,
    <Word ';': addr=775, immediate=True>,
    <Word '<': addr=527, immediate=False>,
    <Word '<<': addr=597, immediate=False>,
    <Word '<=': addr=545, immediate=False>,
    <Word '<>': addr=605, immediate=False>,
    <Word '=': addr=567, immediate=False>,
    <Word '>': addr=635, immediate=False>,
    <Word '>=': addr=497, immediate=False>,
    <Word '>>': addr=583, immediate=False>,
    <Word '>cfa': addr=188, immediate=False>,
    <Word '?': addr=1009, immediate=False>,
    <Word '@': addr=392, immediate=False>,
    <Word '[': addr=309, immediate=False>,
    <Word ']': addr=318, immediate=True>,
    <Word '^': addr=579, immediate=False>,
    <Word '_cstack': addr=611, immediate=False>,
    ...
    <Word 'drop': addr=623, immediate=False>,
    <Word 'dup': addr=503, immediate=False>,
    <Word 'exit': addr=765, immediate=False>,
    <Word 'false': addr=617, immediate=False>,
    <Word 'find': addr=244, immediate=False>,
    <Word 'here': addr=511, immediate=False>,
    <Word 'immediate': addr=801, immediate=False>,
    <Word 'latest': addr=591, immediate=False>,
    <Word 'matmul': addr=551, immediate=False>,
    <Word 'mod': addr=507, immediate=False>,
    <Word 'nip': addr=488, immediate=False>,
    <Word 'none': addr=573, immediate=False>,
    <Word 'noop': addr=1025, immediate=False>,
    <Word 'nop': addr=517, immediate=False>,
    <Word 'over': addr=434, immediate=False>,
    <Word 'rot': addr=493, immediate=False>,
    <Word 'swap': addr=627, immediate=False>,
    <Word 'true': addr=521, immediate=False>,
    <Word 'tuck': addr=1053, immediate=False>,
    <Word 'word': addr=172, immediate=False>,
    <Word 'words': addr=280, immediate=False>,
    <Word 'xor': addr=533, immediate=False>,
    <Word '|': addr=537, immediate=False>]
